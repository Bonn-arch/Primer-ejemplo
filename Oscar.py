#Cada año en los Oscar, el Premio de la Academia a la Mejor Película se otorga a una sola película. Normalmente es el último premio entregado y es considerado el más prestigioso.
best_pictures = [
  '2019 - Parasite',
  '2018 - Green Book',
